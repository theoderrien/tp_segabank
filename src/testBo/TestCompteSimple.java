...
public class TestCompteSimple {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------------");
        System.out.println("Test unitaire - création d'un compte simple");
        compteSimple = new CompteSimple(1250.47f, 400f, 2);
        System.out.println(compteSimple.toString());
        System.out.println("--------------------------------------------------");

        System.out.println("Test unitaire - versement de 600.00€ sur un compte simple");
        ...
        System.out.println("Test unitaire - retrait de 480.47€ sur un compte simple");
        ...
        System.out.println("Test unitaire - retrait de 1600€ (inférieur au découvert)");
        System.out.println("Solde avant retrait découvert : " + compteSimple.getSolde() + "€");
        compteSimple.retrait(1600.00f);
        System.out.println("Solde après retrait : " + compteSimple.getSolde() + "€");
        System.out.println("--------------------------------------------------");

        System.out.println("Test unitaire - retrait de 270€ (supérieur au découvert)");
        System.out.println("Solde avant retrait découvert : " + compteSimple.getSolde() + "€");
